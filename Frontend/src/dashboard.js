...
function Dashboard() {
  ...
  const fetchCounts = async (month) => {
    try {
      const [agentResponse, ticketResponse] = await Promise.all([
        axios.get(`http://localhost:5000/agents/count`),
        axios.get(`http://localhost:5000/tickets/count?month=${month}`)
      ]);
  ...
  const fetchTicketStats = async () => {
    try {
      const {data} = await axios.get(`http://localhost:5000/tickets/stats`);
  ...
  const fetchTicketPriority = async () => {
    try {
      const response = await axios.get(`http://localhost:5000/tickets/priority`);
  ...
  const fetchTicketStatus = async () => {
    try {
      const response = await axios.get(`http://localhost:5000/tickets/status`);
  ...
  const fetchAgents = async () => {
    try {
      const response = await axios.get(`http://localhost:5000/registration/top/agents`);
  ...
  const fetchTickets = async () => {
    try {
      const response = await fetch(`http://localhost:5000/tickets/list`);
